...
function Modal(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_reactNative.Animated.View, {
    ...
    style: [styles.backdrop, {
      backgroundColor: theme.isV3 ? (0, _color.default)(_tokens.MD3Colors.neutralVariant20).alpha(0.4).rgb().string() : (_theme$colors = theme.colors) === null || _theme$colors === void 0 ? void 0 : _theme$colors.backdrop,
      opacity
    }]
