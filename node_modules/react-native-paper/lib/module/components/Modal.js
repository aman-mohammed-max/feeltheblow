...
export default function Modal(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Animated.View, {
    ...
    style: [styles.backdrop, {
      backgroundColor: theme.isV3 ? color(MD3Colors.neutralVariant20).alpha(0.4).rgb().string() : (_theme$colors = theme.colors) === null || _theme$colors === void 0 ? void 0 : _theme$colors.backdrop,
      opacity
    }]
